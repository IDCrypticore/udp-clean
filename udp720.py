...
gst_str = "nvcompositor name=mix background-w=1280 background-h=180 \
    ...
    ! video/x-raw(memory:NVMM),format=RGBA, width=1280,height=180 ! nvvidconv flip_method=2 ! video/x-raw(memory:NVMM),format=I420 ! nvv4l2h264enc insert-vui=1 insert-sps-pps=1 ! h264parse ! rtph264pay ! udpsink host=127.0.0.1 port=5000  \
