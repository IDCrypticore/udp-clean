...
gst_str = "nvcompositor name=mix background-w=1920 background-h=270 \
    ...
    ! video/x-raw(memory:NVMM),format=RGBA, width=1920,height=270 ! nvvidconv flip-method=2 ! video/x-raw(memory:NVMM),format=I420 ! nvv4l2h264enc insert-vui=1 insert-sps-pps=1 ! h264parse ! rtph264pay ! udpsink host=127.0.0.1 port=5000  \
